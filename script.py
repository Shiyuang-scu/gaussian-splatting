...
command = [
    ...
    '--eval',
    '--densify_from_iter', int(500 * training_set_size/200), # default is 500, for 200 images dataset
    '--densify_until_iter', int(15_000 * training_set_size/200), # default is 15_000, for 200 images dataset
    '--densification_interval', int(100 * training_set_size/200), # default is 100, for 200 images dataset
